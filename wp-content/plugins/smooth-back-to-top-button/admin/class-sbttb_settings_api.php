...
if ( ! class_exists( 'SBTTB_Settings_API' ) ):
    class SBTTB_Settings_API {
        ...
        function callback_file( $args ) {
            ...
            $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'wc-minmax-quantities' );
        ...
        function script() {
            ...
            <script>
                jQuery(document).ready(function ($) {
                    ...
                    // let pro_html = '<span class="pro_feature" ><?php echo esc_html__( 'PRO', 'smooth-back-to-top-button' ); ?></span>';
                    // let pro_link_html = '<a href="#" target="_blank" class="upgrade_to_pro"><?php echo esc_html__( 'UPGRADE TO PRO', 'smooth-back-to-top-button' ); ?> &#8594;</a>';
                    // $('.progress_width').find('input').prop('disabled', true).after(pro_link_html);
                    // $('.progress_width').find('label').append(pro_html);
        ...
        function _style_fix() {
            ...
            <style type="text/css">
                ...
                .sbttb-settings-content .form-table th {
                    width: 250px;
                }

                .sbttb-settings-content .form-table td input[type="number"] {
                    width: 60px;
                }
                ...
                .form-table .icon_type td fieldset label {
                    margin-right: 15px !important;
                }

                .progress_width span.pro_feature {
                    background: #f65858;
                    color: #fff;

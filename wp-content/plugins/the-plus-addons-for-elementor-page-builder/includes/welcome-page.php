		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">July 18, 2023 <span class="changelog-version">Lite Version 5.2.12</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Client Listout : Document Link', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Hover card : Document Link', 'tpebl').'</li>';
